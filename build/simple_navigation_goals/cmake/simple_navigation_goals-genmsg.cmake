...
message(STATUS "simple_navigation_goals: 1 messages, 1 services")

set(MSG_I_FLAGS "-Isimple_navigation_goals:/home/c01/naya_navigation/src/simple_navigation_goals/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/c01/naya_navigation/src/simple_navigation_goals/srv/multi_point.srv" NAME_WE)
add_custom_target(_simple_navigation_goals_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "simple_navigation_goals" "/home/c01/naya_navigation/src/simple_navigation_goals/srv/multi_point.srv" ""
)

get_filename_component(_filename "/home/c01/naya_navigation/src/simple_navigation_goals/msg/auto_info.msg" NAME_WE)
add_custom_target(_simple_navigation_goals_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "simple_navigation_goals" "/home/c01/naya_navigation/src/simple_navigation_goals/msg/auto_info.msg" ""
)
...
_generate_msg_cpp(simple_navigation_goals
  "/home/c01/naya_navigation/src/simple_navigation_goals/msg/auto_info.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Services
_generate_srv_cpp(simple_navigation_goals
  "/home/c01/naya_navigation/src/simple_navigation_goals/srv/multi_point.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gencpp_INSTALL_DIR}/simple_navigation_goals
)
...
### Generating Services
_generate_srv_eus(simple_navigation_goals
  "/home/c01/naya_navigation/src/simple_navigation_goals/srv/multi_point.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/simple_navigation_goals
...
### Generating Services
_generate_srv_lisp(simple_navigation_goals
  "/home/c01/naya_navigation/src/simple_navigation_goals/srv/multi_point.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genlisp_INSTALL_DIR}/simple_navigation_goals
...
### Generating Services
_generate_srv_nodejs(simple_navigation_goals
  "/home/c01/naya_navigation/src/simple_navigation_goals/srv/multi_point.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/simple_navigation_goals
...
### Generating Services
_generate_srv_py(simple_navigation_goals
  "/home/c01/naya_navigation/src/simple_navigation_goals/srv/multi_point.srv"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/simple_navigation_goals
