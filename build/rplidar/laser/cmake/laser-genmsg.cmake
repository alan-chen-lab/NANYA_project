...
message(STATUS "laser: 0 messages, 0 services")
...
### Generating Module File
_generate_module_eus(laser
  ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/laser
  "${ALL_GEN_OUTPUT_FILES_eus}"
)

add_custom_target(laser_generate_messages_eus
  DEPENDS ${ALL_GEN_OUTPUT_FILES_eus}
)
add_dependencies(laser_generate_messages laser_generate_messages_eus)

# add dependencies to all check dependencies targets

# target for backward compatibility
add_custom_target(laser_geneus)
add_dependencies(laser_geneus laser_generate_messages_eus)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS laser_generate_messages_eus)
...
### Generating Module File
_generate_module_nodejs(laser
  ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/laser
  "${ALL_GEN_OUTPUT_FILES_nodejs}"
)

add_custom_target(laser_generate_messages_nodejs
  DEPENDS ${ALL_GEN_OUTPUT_FILES_nodejs}
)
add_dependencies(laser_generate_messages laser_generate_messages_nodejs)

# add dependencies to all check dependencies targets

# target for backward compatibility
add_custom_target(laser_gennodejs)
add_dependencies(laser_gennodejs laser_generate_messages_nodejs)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS laser_generate_messages_nodejs)
...
if(TARGET sensor_msgs_generate_messages_cpp)
  add_dependencies(laser_generate_messages_cpp sensor_msgs_generate_messages_cpp)
endif()

if(geneus_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/laser)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${geneus_INSTALL_DIR}/laser
    DESTINATION ${geneus_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_eus)
  add_dependencies(laser_generate_messages_eus std_msgs_generate_messages_eus)
endif()
if(TARGET sensor_msgs_generate_messages_eus)
  add_dependencies(laser_generate_messages_eus sensor_msgs_generate_messages_eus)
endif()
...
if(TARGET sensor_msgs_generate_messages_lisp)
  add_dependencies(laser_generate_messages_lisp sensor_msgs_generate_messages_lisp)
endif()

if(gennodejs_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/laser)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${gennodejs_INSTALL_DIR}/laser
    DESTINATION ${gennodejs_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_nodejs)
  add_dependencies(laser_generate_messages_nodejs std_msgs_generate_messages_nodejs)
endif()
if(TARGET sensor_msgs_generate_messages_nodejs)
  add_dependencies(laser_generate_messages_nodejs sensor_msgs_generate_messages_nodejs)
endif()

if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/laser\")")
  # install generated code
  install(
...
if(TARGET sensor_msgs_generate_messages_py)
  add_dependencies(laser_generate_messages_py sensor_msgs_generate_messages_py)
endif()
