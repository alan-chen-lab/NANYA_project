...
if("TRUE" STREQUAL "TRUE")
  set(nav_core_SOURCE_PREFIX /home/c01/naya_navigation/src/navigation-kinetic-devel/nav_core)
  set(nav_core_DEVEL_PREFIX /home/c01/naya_navigation/devel)
  set(nav_core_INSTALL_PREFIX "")
  set(nav_core_PREFIX ${nav_core_DEVEL_PREFIX})
else()
  set(nav_core_SOURCE_PREFIX "")
  set(nav_core_DEVEL_PREFIX "")
  set(nav_core_INSTALL_PREFIX /home/c01/naya_navigation/install)
...
if(NOT "/home/c01/naya_navigation/src/navigation-kinetic-devel/nav_core/include " STREQUAL " ")
  set(nav_core_INCLUDE_DIRS "")
  set(_include_dirs "/home/c01/naya_navigation/src/navigation-kinetic-devel/nav_core/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'nav_core' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/c01/naya_navigation/src/navigation-kinetic-devel/nav_core/${idir}'.  ${_report}")
    endif()
