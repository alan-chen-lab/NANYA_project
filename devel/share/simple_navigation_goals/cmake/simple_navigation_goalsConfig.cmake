...
if("TRUE" STREQUAL "TRUE")
  set(simple_navigation_goals_SOURCE_PREFIX /home/c01/naya_navigation/src/simple_navigation_goals)
  set(simple_navigation_goals_DEVEL_PREFIX /home/c01/naya_navigation/devel)
  ...
  set(simple_navigation_goals_INSTALL_PREFIX /home/c01/naya_navigation/install)
...
if(NOT "/home/c01/naya_navigation/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'simple_navigation_goals' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/c01/naya_navigation/src/simple_navigation_goals/${idir}'.  ${_report}")
    endif()
