...
if("TRUE" STREQUAL "TRUE")
  set(amcl_SOURCE_PREFIX /home/c01/naya_navigation/src/navigation-kinetic-devel/amcl)
  set(amcl_DEVEL_PREFIX /home/c01/naya_navigation/devel)
  set(amcl_INSTALL_PREFIX "")
  set(amcl_PREFIX ${amcl_DEVEL_PREFIX})
else()
  set(amcl_SOURCE_PREFIX "")
  set(amcl_DEVEL_PREFIX "")
  set(amcl_INSTALL_PREFIX /home/c01/naya_navigation/install)
...
if(NOT "/home/c01/naya_navigation/devel/include;/home/c01/naya_navigation/src/navigation-kinetic-devel/amcl/include " STREQUAL " ")
  set(amcl_INCLUDE_DIRS "")
  set(_include_dirs "/home/c01/naya_navigation/devel/include;/home/c01/naya_navigation/src/navigation-kinetic-devel/amcl/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'amcl' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/c01/naya_navigation/src/navigation-kinetic-devel/amcl/${idir}'.  ${_report}")
    endif()
